...
# Date: 22/05/2022
# Additional Description: This is a model altered to fit multispecific face swapping instead of regular single image style transfer. Help from code written by Thomas Viehmann was used and tweaked, credit shown in the link.
##############################
"""
